...
export class ErrorBoundary extends React.Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="w-full my-6 bg-white border border-rose-200/80 rounded-2xl p-8 flex flex-col items-center justify-center text-center shadow-sm max-w-2xl mx-auto space-y-4 animate-fade-in" id="error-boundary-container">
          ...
          <div className="flex gap-3 pt-2">
            <button
              ...
              className="px-5 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs rounded-xl shadow-md transition-all flex items-center gap-2 cursor-pointer border border-indigo-500/30 active:scale-[0.98]"
              id="error-retry-btn"
            >
