...
export const translations: Record<string, TranslationStructure> = {
  'pt-BR': {
    ...
    extra: {
      ...
      askAiPricing: 'Precisa de margens automáticas? Pergunte ao Yohan AI para sugestões estruturais.',
  ...
  'es': {
    ...
    extra: {
      ...
      askAiPricing: '¿Necesita márgenes automáticas? Pregunte al Yohan AI para obtener sugerencias estructurales.',
